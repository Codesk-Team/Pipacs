            ...
            <div class="wpb_wrapper">
              <div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_fadeInLeft fadeInLeft text-size-medium">
                ...
                >
                  ...
                  <p>
                    <li>{t("roomsPage.notSmoking")}</li>
                    <li>{t("roomsPage.bathroomEquipments")}</li>
                    <li>{t("roomsPage.parking")}</li>
                    <li>Wifi</li>
                  </p>
                  <p>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="info">
                            {/* <span class="sub-title">Fish</span> */}
                            <h4 class="title">{t("roomsPage.valentineDay")}</h4>
                            <div class="project-description">
                  ...
                  >
                    ...
                    <p>
                      <li style={{ padding: "0px" }}>
                        {t("valentineDay.bulletPointOne")}
                      </li>
                      <li style={{ padding: "0px" }}>
                        {t("valentineDay.bulletPointTwo")}{" "}
                      </li>
                      <li style={{ padding: "0px" }}>
                        {t("valentineDay.bulletPointThree")}
                      </li>
